...
> 实施状态（2026-09-12）：M0–M3 及 M4 Task 18 的坐标 alias、显式 region edges 与单调 worklist 已实现；Task 18 独立复审与 30 lit / 104 unit / 4 CTest 通过，尚未提交/合入 main。其余 M4 Op 迁移尚未实施，可执行 GPU 运行验收仍属 M6。实测与已知边界见实现计划 §18.9。
